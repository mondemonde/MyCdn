...
var total_cards = $('.dcard').length; //any number of cards will work
var card_spacing = 10;
...
function separate_instantly(){
	var left = 0;
	var top = 0;
	var card_width = $('.dcard').width();
	var card_height = $('.dcard').height();
...
$($('.dcard').get().reverse()).each(function(){
	var card = $(this);
	setTimeout(function(){
